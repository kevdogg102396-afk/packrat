# Project Memory — Realistic Sample
...
- Fixed decompress trim() bug
- Fixed literal $K expansion bug
- Benchmark suite at `C:/Users/devuser/projects/packrat/benchmark/`
- Core library: `C:/Users/devuser/projects/packrat/index.mjs`
...
## Critical Rules
1. Check memory files BEFORE searching filesystem or web
2. Never fabricate URLs, data, or information
...
- Lead with the broadest, simplest fix — user is not a developer

## Knowledge Base
- TypeScript + React + Next.js stack for web apps
